...
function initApp() {
    ...
    document.getElementById('btn-role-user')?.addEventListener('click', () => loginAsRole('user'));
    document.getElementById('btn-role-admin')?.addEventListener('click', () => loginAsRole('admin'));
    document.getElementById('btn-admin-exit')?.addEventListener('click', () => { location.reload(); logout(); });
    document.getElementById('btn-accept-gate')?.addEventListener('click', acceptGateAlternative);
    document.getElementById('btn-activate-route')?.addEventListener('click', activateSmartRoute);
